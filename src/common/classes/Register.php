        ...
        public function processRegister( $user_name , $user_email )
        {
            ...
            else
            {
                ...
                <div class="text-center ml-5">
                    ...
                    <a href="http://localhost/src/account/?page=register"><h6><i class="fas fa-chevron-left"></i> Back to home</h6></a>
                </div>';
            }
        }
        ...
        private function processNotifyRegister( $user_name , $user_email )
        {
            ...
            else
            {
                ...
                <div class="text-center ml-5">
                    ...
                    <a href="http://localhost/src/account/?page=login"><h6><i class="fas fa-chevron-left"></i> Back to home</h6></a>
                </div>';
                exit();
            }
        }
